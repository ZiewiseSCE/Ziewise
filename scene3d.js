...
export function mountScene(element, { kind = 'core', onReady, modelFactory = null, onPhase, studioFloor = false } = {}) {
  ...
  const floor = new THREE.Mesh(new THREE.PlaneGeometry(200, 200), studioFloor ? new THREE.ShadowMaterial({color:'#294a62',opacity:.19}) : new THREE.MeshStandardMaterial({ color: sceneBackground, roughness: 0.84, metalness: 0.02 }));
