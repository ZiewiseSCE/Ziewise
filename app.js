...
const i18n = {
    ko: {
        ...
        "certificate-open": "원본 크게 보기 ↗",
        "certificate-iso-desc": "데이터센터 운영서비스의 정보보호 관리체계에 대한 인증입니다. 게시된 증서의 인증 범위는 서버 호스팅 및 가상 PC 운영서비스로, 지와이즈의 인프라 운영과 정보보호 역량을 보여줍니다.",
        "certificate-iso-issuer": "발급기관 · 한국품질재단",
        "certificate-iso-meta": "증서 유효기간 · 2024.09.24 – 2027.09.23",
        "certificate-venture-desc": "혁신성장유형의 벤처기업으로 확인받은 증서입니다. 지와이즈의 기술 기반 사업과 성장 방향을 소개하며, 자체 솔루션 개발과 사업 확장의 기반을 설명합니다.",
        "certificate-venture-issuer": "확인기관 · 벤처기업확인기관",
        "certificate-venture-meta": "증서 유효기간 · 2025.08.26 – 2028.08.25",
        "certificate-rnd-desc": "한국산업기술진흥협회에서 인정한 연구개발전담부서입니다. 사내 전담 조직을 통해 연구개발 활동을 이어가며, 자체 기술 검토와 솔루션 개선을 지속하는 기반입니다.",
        "certificate-rnd-issuer": "인정기관 · 한국산업기술진흥협회",
        "certificate-rnd-meta": "인정서 번호 · 제2024154736호",
        "certificate-pmp-desc": "PMI의 프로젝트 관리 전문자격 취득 증서입니다. 프로젝트와 자원을 정의하고 관리하는 경험·지식·수행 역량에 관한 개인 자격 이력을 소개합니다.",
        "certificate-pmp-issuer": "발급기관 · Project Management Institute",
        "certificate-pmp-meta": "게시 증서 만료일 · 2026.04.07",

        "badge-venture": "벤처기업 확인",
        "badge-rnd": "연구개발전담부서",
        ...
        "tech-title": "현장과 업무를 연결하는 AI 기술",
        "tech-desc": "직접 구현한 코어·현장 분석·운영 자동화의 작동 과정을 살펴보세요.",
    ...
    en: {
        ...
        "badge-iso": "ISO 27001 Certification",
        "certificate-open": "View original ↗",
        "certificate-iso-desc": "Information security management certification for data center operations. The published certificate covers server hosting and virtual PC services, reflecting Ziewise’s infrastructure operations and information security capabilities.",
        "certificate-iso-issuer": "Issued by · Korean Foundation for Quality",
        "certificate-iso-meta": "Certificate period · 2024.09.24 – 2027.09.23",
        "certificate-venture-desc": "The certificate identifies Ziewise as a venture enterprise under the innovation-growth category. It provides context for the company’s technology-led business, in-house solution development and growth direction.",
        "certificate-venture-issuer": "Verified by · Venture Enterprise Confirmation Agency",
        "certificate-venture-meta": "Certificate period · 2025.08.26 – 2028.08.25",
        "certificate-rnd-desc": "A dedicated R&D department recognized by the Korea Industrial Technology Association. The in-house research organization provides a foundation for continuing research, technical evaluation and solution improvement.",
        "certificate-rnd-issuer": "Recognized by · KOITA",
        "certificate-rnd-meta": "Recognition no. · 2024154736",
        "certificate-pmp-desc": "An award certificate for PMI’s Project Management Professional credential. It records an individual qualification in the experience, knowledge and performance involved in defining and managing projects and resources.",
        "certificate-pmp-issuer": "Issued by · Project Management Institute",
        "certificate-pmp-meta": "Published certificate expiry · 2026.04.07",

        "badge-venture": "Venture Enterprise",
        "badge-rnd": "Dedicated R&D Department",
        ...
        "neuro-verify": "0x1C7... Verified",
        "mpulse-sub": "D2C Commerce AI",
        "mpulse-diff": "✓ Behaviour-driven recommendations, campaigns and conversion optimisation · AR product experiences supported",
        "mpulse-overview": "D2C Commerce AI for a brand’s direct sales channels, connecting customer behaviour analysis with personalised recommendations, campaigns and retention. AR try-on also supports the product experience.",
        ...
        "tech-title": "AI technology, connected to real work",
        "tech-desc": "Explore the core, field analysis and operational workflows we have built.",
        ...
        'badge-pmp': 'PMP Credential Award',
...
const extraI18n = {
    ...
    "연구개발전담부서에서 매일 새로운 모델 아키텍처를 검증하며, 고객 환경에 맞는 최적화를 지속합니다.": "Our R&D Center validates new model architectures daily and continuously optimizes for each customer's environment.",
    // Timeline
    "지와이즈 설립 · IT 인프라 사업 런칭": "Ziewise founded · IT Infrastructure business launched",
    "연구개발전담부서 설립 · 벤처기업 인증": "Dedicated R&D department established · Venture certification",
...
Object.assign(i18n.ko, {
 ...
 'brand-lead':'현장의 패턴을 학습하고, 판단을 실행하는 AI.<br>반복 검사와 불량 손실을 줄이는 여정,<br>ZiewCore가 데이터에서 고객의 가치까지 연결합니다.',
...
Object.assign(i18n.en, {
 ...
 'brand-lead':'AI that learns operational patterns and acts on them.<br>From repetitive inspection to avoidable defect losses,<br>ZiewCore connects data to business value.',
